...
export const Footer = () => {
	...
	return (
		<footer className=" bg-brand2 px-8 py-14">
			<div className="container mx-auto md:w-11/12 lg:w-9/12">
				<div className="lg:flex-col-none flex justify-between gap-4 md:grid-cols-2 md:flex-col lg:flex-row  lg:px-2">
